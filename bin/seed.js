...
// just need to run this code once at the start for it to seed the data
const mongoose = require("mongoose");
// Import of the model Movie from './models/Movie.model.js'
const Movie = require("../models/Movie.model");

const MONGODB_URI = "mongodb://localhost/express-cinema-dev";
...
mongoose
  ...
  .then((self) => {
    ...
    // Before adding any documents to the database, let's delete all previous entries (incase there is already something in the database)
...
// run the file with node bin/seed.js in Terminal
